...
public class DDBPredicateUtilsTest
{
    ...
    private static final int EXPECTED_ACCUMULATOR_SIZE = 3;
    ...
    private void verifyAccumulatorValues(List<AttributeValue> accumulator, String value1, String value2, String value3)
    {
        assertEquals(EXPECTED_ACCUMULATOR_SIZE, accumulator.size());
    ...
    public void generateSingleColumnFilter_withMultipleValues_returnsInClauseForWhitelistAndNotInClauseForBlacklist()
    {
        ...
        verifyAccumulatorValues(accumulator, VALUE_1, VALUE_2, VALUE_3);
