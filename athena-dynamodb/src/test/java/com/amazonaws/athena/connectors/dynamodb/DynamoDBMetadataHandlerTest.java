        ...
        extends TestBase
{
    ...
    private static final int EXPECTED_SPLIT_COUNT = 1;
    private static final int EXPECTED_LIMIT_SUBTYPE_COUNT = 1;
    ...
    @Test
    public void doGetTable_withDifferentCase_returnsCorrectTableName()
            throws Exception
    {
        lenient().when(glueClient.getTable(any(software.amazon.awssdk.services.glue.model.GetTableRequest.class))).thenThrow(new AmazonServiceException(""));
    ...
    @Test
    public void doGetTableLayout_withDifferentCase_returnsCorrectTableMetadata()
            throws Exception
    {
        lenient().when(glueClient.getTable(any(software.amazon.awssdk.services.glue.model.GetTableRequest.class))).thenThrow(new AmazonServiceException(""));
    ...
    @Test
    public void doGetTable_withMixedCaseTableName_returnsCorrectTableName()
            throws Exception
    {
        lenient().when(glueClient.getTable(any(software.amazon.awssdk.services.glue.model.GetTableRequest.class))).thenThrow(new AmazonServiceException(""));
        ...
        logger.info("doGetTable_withMixedCaseTableName_returnsCorrectTableName - {}", res.getSchema());
    ...
    @Test
    public void doGetDataSourceCapabilities_returnsCapabilitiesWithLimitAndExpressionPushdown()
    {
        ...
        assertThat(limitSubTypes.size(), equalTo(EXPECTED_LIMIT_SUBTYPE_COUNT));
        ...
        assertThat(expressionSubTypes.size(), equalTo(EXPECTED_LIMIT_SUBTYPE_COUNT));
    }

    @Test
    public void doGetQueryPassthroughSchema_withValidQuery_returnsSchemaWithFields()
            throws Exception
    {
    ...
    @Test
    public void doGetSplits_withQueryPassthrough_returnsSingleSplitWithQuery()
            throws Exception
    {
        // Setup QPT arguments
        ...
        assertNotNull("Response should not be null", response);
        assertEquals(EXPECTED_SPLIT_COUNT, response.getSplits().size());

        // Verify the split has our QPT query
        Split split = response.getSplits().iterator().next();
        assertEquals(SELECT_ALL_QUERY, split.getProperties().get(DDBQueryPassthrough.QUERY));
    }

    @Test
    public void doGetDataSourceCapabilities_withQueryPassthroughEnabled_returnsCapabilitiesWithSystemQuery()
    {
    ...
    @Test
    public void doGetDataSourceCapabilities_withQueryPassthroughDisabled_returnsCapabilitiesWithoutSystemQuery()
    {
        ...
        DynamoDBMetadataHandler handlerWithoutQpt = new DynamoDBMetadataHandler(
                ...
                ddbClient,
                glueClient,
                ImmutableMap.of(ENABLE_QUERY_PASSTHROUGH, FALSE_STRING));
        GetDataSourceCapabilitiesRequest request = new GetDataSourceCapabilitiesRequest(TEST_IDENTITY, TEST_QUERY_ID, TEST_CATALOG_NAME);
