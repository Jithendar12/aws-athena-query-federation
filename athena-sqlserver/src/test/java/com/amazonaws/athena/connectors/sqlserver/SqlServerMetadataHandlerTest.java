        ...
        extends TestBase
{
    ...
    @Test
    public void testDoGetTableWithSqlServerSpecificTypes() throws Exception
    {
        BlockAllocator blockAllocator = new BlockAllocatorImpl();
        String[] schema = {"DATA_TYPE", "COLUMN_SIZE", "COLUMN_NAME", "DECIMAL_DIGITS", "NUM_PREC_RADIX"};
        Object[][] values = {
    ...
    @Test
    public void doGetTable_withUnsupported_fallbackToVarchar() throws Exception
    {
        BlockAllocator blockAllocator = new BlockAllocatorImpl();
        String[] schema = {"DATA_TYPE", "COLUMN_SIZE", "COLUMN_NAME", "DECIMAL_DIGITS", "NUM_PREC_RADIX"};
        Object[][] values = {
    ...
    @Test
    public void testConvertDatasourceTypeToArrowWithSqlServerSpecificTypes() throws Exception
    {
