...
{
    @Test
    public void testGetConnectionReplacesSecretWithCredentials() throws Exception
    {
    ...
    @Test
    public void getConnection_withNullCredentials_doesNotReplaceSecret() throws Exception
    {
