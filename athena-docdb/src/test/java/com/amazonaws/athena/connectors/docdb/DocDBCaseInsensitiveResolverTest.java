...
public class DocDBCaseInsensitiveResolverTest
{
    ...
    @Test
    public void getSchemaNameCaseInsensitiveMatch_whenDisabled_returnsExactMatch()
    {
    ...
    @Test
    public void getSchemaNameCaseInsensitiveMatch_whenEnabled_matchesCaseInsensitively()
    {
    ...
    public void getSchemaNameCaseInsensitiveMatch_whenNoMatchFound_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockDatabaseNames.spliterator()).thenReturn(
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getSchemaNameCaseInsensitiveMatch_whenMultipleMatchesFound_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockDatabaseNames.spliterator()).thenReturn(
    ...
    @Test
    public void getTableNameCaseInsensitiveMatch_whenDisabled_returnsExactMatch()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "false");
    ...
    @Test
    public void getTableNameCaseInsensitiveMatch_whenEnabled_matchesCaseInsensitively()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getTableNameCaseInsensitiveMatch_whenNoMatchFound_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockCollectionNames.spliterator()).thenReturn(
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getTableNameCaseInsensitiveMatch_whenMultipleMatchesFound_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockCollectionNames.spliterator()).thenReturn(
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getSchemaNameCaseInsensitiveMatch_whenEmptyList_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockDatabaseNames.spliterator()).thenReturn(
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getTableNameCaseInsensitiveMatch_whenEmptyList_throwsIllegalArgumentException()
    {
        configOptions.put(ENABLE_CASE_INSENSITIVE_MATCH, "true");
        when(mockCollectionNames.spliterator()).thenReturn(
            Collections.<String>emptyList().spliterator());
