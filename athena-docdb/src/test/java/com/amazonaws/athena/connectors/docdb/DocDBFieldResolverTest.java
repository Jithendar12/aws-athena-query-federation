...
public class DocDBFieldResolverTest
{
    ...
    @Test
    public void getFieldValue_whenFieldIsList_returnsListValue()
    {
    ...
    @Test
    public void getFieldValue_whenFieldIsSimpleDocument_returnsSimpleValue()
    {
    ...
    @Test
    public void getFieldValue_whenFieldIsDBRef_returnsDBRefFields()
    {
    ...
    @Test
    public void getFieldValue_whenFieldIsNestedDocument_returnsNestedDocument()
    {
    ...
    @Test
    public void getFieldValue_whenFieldIsComplexList_returnsListOfDocuments()
    {
    ...
    public void getFieldValue_whenValueIsInvalidType_throwsRuntimeException()
    {
