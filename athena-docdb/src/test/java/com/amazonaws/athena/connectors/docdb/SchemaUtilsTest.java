...
public class SchemaUtilsTest
{
    ...
    @Test
    public void testInferSchema_withEmptyCollection()
    {
        List<Document> docs = new ArrayList<>();
        MongoDatabase mockDatabase = setupMockDatabase(docs);
    ...
    @Test
    public void testInferSchema_withNoColumns()
    {
        List<Document> docs = new ArrayList<>();
    ...
    @Test
    public void testInferSchema_withMergeListFields()
    {
        List<Document> docs = new ArrayList<>();
    ...
    @Test
    public void testInferSchema_withMergeStructFields()
    {
        List<Document> docs = new ArrayList<>();
    ...
    @Test
    public void testInferSchema_withMergeNestedListOfStructs()
    {
        List<Document> docs = new ArrayList<>();
    ...
    @Test
    public void testInferSchema_withMergeStructContainingListAndStructFields()
    {
        List<Document> docs = new ArrayList<>();
