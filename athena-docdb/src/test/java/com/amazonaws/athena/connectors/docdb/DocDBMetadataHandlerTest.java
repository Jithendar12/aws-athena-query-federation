    ...
    extends TestBase
{
            ...
            throws Exception
    {
        ...
        DocDBMetadataHandler caseInsensitiveHandler = new DocDBMetadataHandler(awsGlue,
                ...
                SPILL_BUCKET, SPILL_PREFIX, com.google.common.collect.ImmutableMap.of(ENABLE_CASE_INSENSITIVE_MATCH, TRUE_STRING));
        List<Document> documents = new ArrayList<>();
        ...
        Field unsupported = res.getSchema().findField(UNSUPPORTED_FIELD);
        assertEquals(Types.MinorType.VARCHAR, Types.getMinorTypeForArrowType(unsupported.getType()));
    }
            ...
            throws Exception
    {
        ...
        assertEquals(Types.MinorType.VARCHAR, Types.getMinorTypeForArrowType(fields.get(UNSUPPORTED_FIELD).getType()));
    ...
    public void doGetDataSourceCapabilities_withQueryPassthroughEnabled_returnsCapabilities()
    {
        ...
        configOptions.put(ENABLE_QUERY_PASSTHROUGH, TRUE_STRING);
    ...
    public void doGetQueryPassthroughSchema_withValidParameters_returnsSchema() throws Exception
    {
        ...
        queryPassthroughParameters.put(ENABLE_QUERY_PASSTHROUGH, TRUE_STRING);
        ...
        Field titleField = schema.findField(TITLE_FIELD);
        ...
        Field yearField = schema.findField(YEAR_FIELD);
        ...
        Field typeField = schema.findField(TYPE_FIELD);
            ...
            throws Exception
    {
        ...
        invalidParams.put(ENABLE_QUERY_PASSTHROUGH, TRUE_STRING);
