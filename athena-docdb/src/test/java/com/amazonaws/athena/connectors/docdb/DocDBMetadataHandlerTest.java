    ...
    extends TestBase
{
            ...
            throws Exception
    {
        ...
        assertMinorType(res, STRING_COL, Types.MinorType.VARCHAR);
        assertMinorType(res, STRING_COL2, Types.MinorType.VARCHAR);
        assertMinorType(res, INT_COL, Types.MinorType.INT);
        assertMinorType(res, INT_COL2, Types.MinorType.INT);
        assertMinorType(res, DOUBLE_COL, Types.MinorType.FLOAT8);
        assertMinorType(res, DOUBLE_COL2, Types.MinorType.FLOAT8);
        assertMinorType(res, LONG_COL, Types.MinorType.BIGINT);
        assertMinorType(res, LONG_COL2, Types.MinorType.BIGINT);
        assertMinorType(res, BOOLEAN_COL, Types.MinorType.BIT);
        assertMinorType(res, BOOLEAN_COL2, Types.MinorType.BIT);
        assertMinorType(res, FLOAT_COL, Types.MinorType.FLOAT4);
        assertMinorType(res, FLOAT_COL2, Types.MinorType.FLOAT4);
        assertMinorType(res, DATE_COL, Types.MinorType.DATEMILLI);
        assertMinorType(res, DATE_COL2, Types.MinorType.DATEMILLI);
        assertMinorType(res, TIMESTAMP_COL, Types.MinorType.DATEMILLI);
        assertMinorType(res, TIMESTAMP_COL2, Types.MinorType.DATEMILLI);
        assertMinorType(res, OBJECT_ID_COL, Types.MinorType.VARCHAR);
        assertMinorType(res, OBJECT_ID_COL2, Types.MinorType.VARCHAR);
        assertMinorType(res, UNSUPPORTED_FIELD, Types.MinorType.VARCHAR);
    }
    ...
    private void assertMinorType(GetTableResponse res, String field, Types.MinorType expected)
    {
        Field f = res.getSchema().findField(field);
        assertNotNull(f);
