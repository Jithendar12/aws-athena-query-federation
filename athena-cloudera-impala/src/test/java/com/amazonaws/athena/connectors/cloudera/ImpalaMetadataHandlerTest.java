...
public class ImpalaMetadataHandlerTest
   ...
   @Test
    ...
    public void testDoGetSplits_withContinuationToken()
    {
        ...
        schemaBuilder.addField(ImpalaConstants.BLOCK_PARTITION_COLUMN_NAME, org.apache.arrow.vector.types.Types.MinorType.VARCHAR.getType());
        ...
        partitionsBlock.setValue(ImpalaConstants.BLOCK_PARTITION_COLUMN_NAME, 0, "partition_0");
        partitionsBlock.setValue(ImpalaConstants.BLOCK_PARTITION_COLUMN_NAME, 1, "partition_1");
        ...
        Set<String> actualPartitions = getSplitsResponse.getSplits().stream()
                .map(split -> split.getProperties().get(ImpalaConstants.BLOCK_PARTITION_COLUMN_NAME))
                .collect(Collectors.toSet());
