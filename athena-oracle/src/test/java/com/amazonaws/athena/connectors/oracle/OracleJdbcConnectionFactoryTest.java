...
public class OracleJdbcConnectionFactoryTest
{
    ...
    @Test
    public void testGetConnectionOverSsl() throws Exception
    {
        withEnvironmentVariable("is_fips_enabled", "true").execute(() -> {
            ...
            // Use mock driver to intercept connection call
    ...
    public void getConnection_withNullCredentialsProvider_throwsRuntimeException()
    {
        DatabaseConnectionConfig config = new DatabaseConnectionConfig(
                ...
                "oracle://jdbc:oracle:thin:username/password@//test.oracle.com:1521/orcl", "test");
    ...
    public void getConnection_whenDriverFailsToConnect_throwsRuntimeException() throws Exception
    {
        ...
        String jdbcUrl = "oracle://jdbc:oracle:thin:user/password@//test.oracle.com:1521/orcl";
        DatabaseConnectionConfig config = new DatabaseConnectionConfig("catalog", OracleConstants.ORACLE_NAME, jdbcUrl, "test");
        DatabaseConnectionInfo info = new DatabaseConnectionInfo(OracleConstants.ORACLE_DRIVER_CLASS, OracleConstants.ORACLE_DEFAULT_PORT);
