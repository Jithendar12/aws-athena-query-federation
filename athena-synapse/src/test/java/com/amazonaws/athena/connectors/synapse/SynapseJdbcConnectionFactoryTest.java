...
public class SynapseJdbcConnectionFactoryTest
{
    ...
    public void testGetConnectionWithCredentialsReplacesSecret()
    {
        try {
            ...
            String originalJdbcUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb;${test}";
            DatabaseConnectionConfig config = new DatabaseConnectionConfig("catalog", "synapse", originalJdbcUrl, "test");
            ...
            String expectedUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb;user=user1;password=pass1";
    ...
    @Test
    public void testGetConnectionWithActiveDirectoryServicePrincipal()
    {
        try {
            DefaultCredentials credentials = new DefaultCredentials("user1", "pass1");
            CredentialsProvider credentialsProvider = new StaticCredentialsProvider(credentials);

            String originalJdbcUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb;authentication=ActiveDirectoryServicePrincipal;${test}";
            DatabaseConnectionConfig config = new DatabaseConnectionConfig("catalog", "synapse", originalJdbcUrl, "test");
            ...
            String expectedUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb;authentication=ActiveDirectoryServicePrincipal;AADSecurePrincipalId=user1;AADSecurePrincipalSecret=pass1";
            assertEquals(expectedUrl, actualUrl.get());
            assertEquals(mockConnection, connection);
    ...
    @Test
    public void testGetConnectionWithNullCredentialsDoesNotReplaceSecret()
    {
        try {
            String jdbcUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb;user=admin;password=admin";
            DatabaseConnectionConfig config = new DatabaseConnectionConfig("catalog", "synapse", jdbcUrl, "test");
    ...
    {
        String jdbcUrl = "jdbc:sqlserver://sql.azuresynapse.net:1433;databaseName=testdb";
        DatabaseConnectionConfig config = new DatabaseConnectionConfig("catalog", "synapse", jdbcUrl, "test");
