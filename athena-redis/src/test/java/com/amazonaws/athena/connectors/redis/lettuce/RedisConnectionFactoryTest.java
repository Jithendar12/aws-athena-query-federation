...
public class RedisConnectionFactoryTest
{
    ...
    @Test
    public void testGetConnection_withStandaloneRedis_returnsConnection()
    {
    ...
    @Test
    public void testGetConnection_withClusterRedis_returnsConnection()
    {
        try (MockedStatic<RedisClusterClient> redisClusterClientStatic = mockStatic(RedisClusterClient.class)) {
    ...
    public void testGetConnection_withInvalidEndpoint_throwsException()
    {
