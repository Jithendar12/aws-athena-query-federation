...
public class Db2FederationExpressionParserTest
{
    ...
    @Test
    public void testWriteArrayConstructorClause_whenSingleArgument()
    {
        assertEquals("value1", parser.writeArrayConstructorClause(mockArrowType, Collections.singletonList("value1")));
    }

    @Test
    public void testWriteArrayConstructorClause_whenMultipleArguments()
    {
    ...
    @Test
    public void testWriteArrayConstructorClause_whenEmptyArguments()
    {
        assertEquals("", parser.writeArrayConstructorClause(mockArrowType, Collections.emptyList()));
    }

    @Test
    public void testWriteArrayConstructorClause_whenArgumentsHaveSpaces()
    {
    ...
    @Test
    public void testWriteArrayConstructorClause_whenArgumentsHaveSpecialCharacters()
    {
