...
public class AWSRequestSigningApacheInterceptorTest
{
    ...
    @Test
    public void process_withValidRequest_processesRequest() throws Exception
    {
    ...
    @Test
    public void process_withEntityEnclosingRequest_processesRequest() throws Exception
    {
        ...
        interceptor.process(request, context);
        assertNotNull("Request with entity should be processed", request);
    }

    @Test
    public void process_withEntityEnclosingRequestWithoutEntity_processesRequest() throws Exception
    {
        HttpPost request = new HttpPost(TEST_URI);
        // No entity set

        interceptor.process(request, context);
        assertNotNull("Request without entity should be processed", request);
    }

    @Test
    public void process_withNullHostInContext_processesRequest() throws Exception
    {
        HttpContext contextWithoutHost = new BasicHttpContext();
        HttpRequest request = new HttpGet(TEST_URI);

        interceptor.process(request, contextWithoutHost);
        assertNotNull("Request without host in context should be processed", request);
    }
    ...
    @Test
    public void process_withEntityEnclosingRequestAndEntity_processesRequestAndSetsEntityContent()
            throws Exception
    {
        HttpPost request = new HttpPost(TEST_URI);
        StringEntity entity = new StringEntity(TEST_BODY);
        ...
        interceptor.process(request, context);
        assertNotNull("Request with entity and entity content should be processed", request);
        assertNotNull("Entity should be set on request", request.getEntity());
    }

    @Test
    public void process_withQueryParameters_processesRequestWithMultipleValuesForSameKey()
            throws Exception
    {
        ...
        // Verify the request was processed successfully (query parameters with multiple values are handled)
        assertNotNull("Request with query parameters should be processed", request);
        // The process method should handle multiple values for the same key without throwing an exception
    }
